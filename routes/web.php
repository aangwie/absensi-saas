...
Route::prefix('admin')->name('admin.')->middleware(['auth', 'tenant'])->group(function () {
    ...
    Route::post('students/{student}/clear-device', [StudentController::class, 'clearDevice'])->name('students.clearDevice');
    ...
    Route::post('teachers/{teacher}/clear-device', [TeacherController::class, 'clearDevice'])->name('teachers.clearDevice');
    ...
    Route::prefix('attendance-schedule')->name('attendance-schedule.')->middleware('role:super_admin')->group(function () {
        ...
        Route::post('/', [\App\Http\Controllers\Admin\AttendanceScheduleController::class, 'store'])->name('store');
    });
});
