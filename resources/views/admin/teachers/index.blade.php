    ...
    <div class="p-5">
        <form method="GET" class="mb-4">
            <div class="relative max-w-sm">
                ...
                <input type="text" name="search" value="{{ request('search') }}" placeholder="Cari nama atau NIP..." class="w-full pl-10 pr-4 py-2.5 rounded-xl border border-slate-300 text-sm focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
            </div>
        </form>
        <div class="overflow-x-auto">
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-slate-100">
                    ...
                    <tr class="hover:bg-slate-50/50 transition-colors">
                        ...
                        <td class="py-3 px-3">
                            <div class="flex items-center justify-center gap-1">
                                ...
                                <button onclick="confirmDelete('delete-teacher-{{ $teacher->id }}', '{{ $teacher->name }}')" class="p-2 rounded-lg text-slate-500 hover:bg-red-50 hover:text-red-600 transition-colors">
                    ...
                    @empty
                    <tr><td colspan="7" class="py-12 text-center text-slate-400">Belum ada data guru</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
